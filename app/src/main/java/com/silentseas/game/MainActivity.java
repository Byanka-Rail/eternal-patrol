...
public class MainActivity extends Activity {
    ...
    private static final String BUNDLED_GAME_VERSION = "6.24.2";
    private static final int FALLBACK_VERSION_CODE = 62402;
    ...
    private byte[] download(String url, int limit) throws Exception {
        ...
        c.setRequestProperty("User-Agent", "ETERNAL-PATROL-Android/6.24.2");
